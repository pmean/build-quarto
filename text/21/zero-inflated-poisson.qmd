...
```{r}
#| label: zero-inflated-poisson-01
#| message: false
#| warning: false
...
```{r}
#| label: zero-inflated-poisson-02
#| eval: false
...
```{r}
#| label: zero-inflated-poisson-03}
...
```{r}
#| label: zero-inflated-poisson-04
...
```{r}
#| label: zero-inflated-poisson-05
...
[sim2]: http://new.pmean.com/zero-inflated-poisson/
