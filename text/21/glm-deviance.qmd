...
Deviance is a measure computed for generalized linear models that can help you decide between two competing models. It is somewhat analogous to residual sums of squares in linear regression.

```{r}
#| label: glm-deviance-01
#| message: false
#| warning: false
...
```{r}
#| label: glm-deviance-02, eval=FALSE}
...
[sim2]: http://new.pmean.com/glm-deviance/
