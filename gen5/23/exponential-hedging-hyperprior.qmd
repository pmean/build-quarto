...
A contour plot shows where the probability is concentrated. The labels on the contour lines represent how much probability is found inside the contour line.
...
[sim2]: http://new.pmean.com/exponential-hedging-hyperprior/
