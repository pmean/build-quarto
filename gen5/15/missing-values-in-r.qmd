...
```{r}
#| label: missing-values-in-r-03

head(sl)
```

```{r}
#| label: missing-values-in-r-04
...
```{r}
#| label: missing-values-in-r-06

table(table(sl$Species))
```

```{r}
#| label: missing-values-in-r-07
...
```{r}
#| label: missing-values-in-r-11

table(sl$Gestation,useNA="ifany")
```

```{r}
#| label: missing-values-in-r-12

table(sl$Danger,useNA="ifany")
```

```{r}
#| label: missing-values-in-r-13
...
```{r}
#| label: missing-values-in-r-14

mean(sl$Gestation,na.rm=FALSE)
```

```{r}
#| label: missing-values-in-r-15

mean(sl$Gestation,na.rm=TRUE)
```

```{r}
#| label: missing-values-in-r-16
...
```{r}
#| label: missing-values-in-r-27

1/0
```

```{r}
#| label: missing-values-in-r-28

-1/0
```

```{r}
#| label: missing-values-in-r-29
...
```{r}
#| label: missing-values-in-r-30

Inf>3
```

```{r}
#| label: missing-values-in-r-31

NaN>3
```

```{r}
#| label: missing-values-in-r-32

Inf==Inf
```

```{r}
#| label: missing-values-in-r-33
...
```{r}
#| label: missing-values-in-r-34

Inf+1
```

```{r}
#| label: missing-values-in-r-35

1/Inf
```

```{r}
#| label: missing-values-in-r-36

0*Inf
```

```{r}
#| label: missing-values-in-r-37
...
[sim2]: http://new.pmean.com/missing-values-in-r/
