...
for (file_name in file_list) {
  ...
  file_source <- identify_source(file_text)
  
  if (file_sim1 == "abend" & file_source == "abend") next
  ...
  if (file_sim1 == "abend") {
    extra_lines <- c(
      ...
      "",
      glue("[sim1]: {file_source}"),
      glue("[sim2]: http://new.pmean.com/{file_root}/"),
      "")
    file_text <- c(file_text, extra_lines)
  }
  
  if (file_source == "abend") file_text <- insert_source(file_text, file_sim1)
